...
// Output function that returns object containing key as length of words and value as number of words of that length
...
function wordSizes(str) {
  let removeMultiSpace = str.replace(/\s\s+/g, " ");
